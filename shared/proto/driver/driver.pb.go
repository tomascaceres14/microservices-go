...
const file_driver_proto_rawDesc = "" +
	...
	"\blocation\x18\a \x01(\v2\x10.driver.LocationR\blocation\"U\n" +
	...
	"\x06driver\x18\x01 \x01(\v2\x0e.driver.DriverR\x06driver\"D\n" +
	"\bLocation\x12\x1a\n" +
...
var file_driver_proto_goTypes = []any{
	...
	(*RegisterDriverRequest)(nil),  // 1: driver.RegisterDriverRequest
	(*RegisterDriverResponse)(nil), // 2: driver.RegisterDriverResponse
	(*Location)(nil),               // 3: driver.Location
}
var file_driver_proto_depIdxs = []int32{
	3, // 0: driver.Driver.location:type_name -> driver.Location
	0, // 1: driver.RegisterDriverResponse.driver:type_name -> driver.Driver
	1, // 2: driver.DriverService.RegisterDriver:input_type -> driver.RegisterDriverRequest
	1, // 3: driver.DriverService.UnregisterDriver:input_type -> driver.RegisterDriverRequest
	2, // 4: driver.DriverService.RegisterDriver:output_type -> driver.RegisterDriverResponse
	2, // 5: driver.DriverService.UnregisterDriver:output_type -> driver.RegisterDriverResponse
